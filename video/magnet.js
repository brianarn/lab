...
(function (window, document) {
    // Paranoia
    "use strict"; // Loved it in Perl, gonna like it over here, I do believe
    
    // Variables
    var vid      // Video DOM reference
    , FPS      // Framerate of video copy
    ...
    // baseToResult: Render the base into the result
    // Really, this function is just a bit of DRYing up
    function baseToResult() {
        resctx.drawImage(
            base,
    ...
    function magnetize() {
        ...
        // Bounds check: No sense doing cursor work
        // if we're too far to be seen
        ...
        for (y = 0; y < cursor.height; y += 1) {
            for (x = 0; x < cursor.width; x += 1) {
